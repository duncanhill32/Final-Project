...
Once again, the Eagles, Patriots and Rams are at the top. This time the "normal" team of the Chargers is at the bottom.

From this it can be seen that the most successful teams not only have the most points scored, they also have a fair amount of points scored against them. Because of this we can say that NFL games can be expected to be more interesting if more points are going to be scored. 
...
* The most consistent relationship between these two seasons is how Temperature and the Week are related. The NFL regular season starts in August and goes through January, so the temperature is decreasing by the week.

* In 2017, there appeared to be a weak positive correlation between Temperature and the Over/Under. This would indicate that colder games are expected to be lower scoring. However, this apparent relationship disappeared in 2018. 
...
From this graphic, environmental causes such as wind speed and temperature did not distinctly affect the game score. The NFL did not have an external factor change the way games. However, there was a change in the form of high quality, high scoring games.
